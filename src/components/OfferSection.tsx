...
const features = [
  "Videoaulas práticas e rápidas, com dicas valiosas para você destravar o seu emagrecimento e definição",
  ...
  "Calculadora TMB com videoaula de como utilizar para acompanhar seus resultados",
